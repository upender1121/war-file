...
public class Storyboard_Impl_smallDisplayArrows extends com.google.gwt.user.client.ui.Composite implements org.cruxframework.crux.widgets.client.storyboard.Storyboard {
  public Storyboard_Impl_smallDisplayArrows(){
    org.cruxframework.crux.core.client.screen.views.org_cruxframework_crux_widgets_client_storyboard_Storyboard_smallDisplayArrows view2 = new org.cruxframework.crux.core.client.screen.views.org_cruxframework_crux_widgets_client_storyboard_Storyboard_smallDisplayArrows("Storyboard"+(_idGen++));
    this._controller = new org.cruxframework.crux.widgets.client.storyboard.StoryboardSmallController_ControllerProxy(view2);
    ((org.cruxframework.crux.core.client.controller.crossdevice.DeviceAdaptiveController)this._controller).setBoundWidget(this);
    view2.setController(this._controller);
    initWidget(viewContainer.asWidget());
    viewContainer.add(view2, true, null);
  ...
  private static java.util.logging.Logger logger26 = java.util.logging.Logger.getLogger(Storyboard_Impl_smallDisplayArrows.class.getName());
