...
public class Storyboard_Impl_largeDisplayArrows extends com.google.gwt.user.client.ui.Composite implements org.cruxframework.crux.widgets.client.storyboard.Storyboard {
  public Storyboard_Impl_largeDisplayArrows(){
    org.cruxframework.crux.core.client.screen.views.org_cruxframework_crux_widgets_client_storyboard_Storyboard_largeDisplayArrows view = new org.cruxframework.crux.core.client.screen.views.org_cruxframework_crux_widgets_client_storyboard_Storyboard_largeDisplayArrows("Storyboard"+(_idGen++));
    this._controller = new org.cruxframework.crux.widgets.client.storyboard.StoryboardLargeController_ControllerProxy(view);
    ...
    viewContainer.add(view, true, null);
  ...
  private static java.util.logging.Logger logger11 = java.util.logging.Logger.getLogger(Storyboard_Impl_largeDisplayArrows.class.getName());
