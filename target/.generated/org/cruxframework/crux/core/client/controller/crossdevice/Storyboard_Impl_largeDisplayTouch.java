...
public class Storyboard_Impl_largeDisplayTouch extends com.google.gwt.user.client.ui.Composite implements org.cruxframework.crux.widgets.client.storyboard.Storyboard {
  public Storyboard_Impl_largeDisplayTouch(){
    org.cruxframework.crux.core.client.screen.views.org_cruxframework_crux_widgets_client_storyboard_Storyboard_largeDisplayTouch view1 = new org.cruxframework.crux.core.client.screen.views.org_cruxframework_crux_widgets_client_storyboard_Storyboard_largeDisplayTouch("Storyboard"+(_idGen++));
    this._controller = new org.cruxframework.crux.widgets.client.storyboard.StoryboardLargeController_ControllerProxy(view1);
    ((org.cruxframework.crux.core.client.controller.crossdevice.DeviceAdaptiveController)this._controller).setBoundWidget(this);
    view1.setController(this._controller);
    initWidget(viewContainer.asWidget());
    viewContainer.add(view1, true, null);
  ...
  private org.cruxframework.crux.widgets.client.storyboard.StoryboardLargeController_ControllerProxy _controller;
  ...
  private static java.util.logging.Logger logger21 = java.util.logging.Logger.getLogger(Storyboard_Impl_largeDisplayTouch.class.getName());
