...
public class Storyboard_Impl_largeDisplayMouse extends com.google.gwt.user.client.ui.Composite implements org.cruxframework.crux.widgets.client.storyboard.Storyboard {
  public Storyboard_Impl_largeDisplayMouse(){
    org.cruxframework.crux.core.client.screen.views.org_cruxframework_crux_widgets_client_storyboard_Storyboard_largeDisplayMouse view0 = new org.cruxframework.crux.core.client.screen.views.org_cruxframework_crux_widgets_client_storyboard_Storyboard_largeDisplayMouse("Storyboard"+(_idGen++));
    this._controller = new org.cruxframework.crux.widgets.client.storyboard.StoryboardLargeMouseController_ControllerProxy(view0);
    ((org.cruxframework.crux.core.client.controller.crossdevice.DeviceAdaptiveController)this._controller).setBoundWidget(this);
    view0.setController(this._controller);
    initWidget(viewContainer.asWidget());
    viewContainer.add(view0, true, null);
  ...
  private org.cruxframework.crux.widgets.client.storyboard.StoryboardLargeMouseController_ControllerProxy _controller;
  ...
  private static java.util.logging.Logger logger16 = java.util.logging.Logger.getLogger(Storyboard_Impl_largeDisplayMouse.class.getName());
