  ...
  public static void init(){
    if (!View.containsResource("xStandardResources")){
      ...
      if (com.google.gwt.logging.client.LogConfiguration.loggingIsEnabled()){
        logger3.fine(Crux.getMessages().resourceCsssInjected("CssXStandardLarge"));
      }
      View.addResource("xStandardResources", resource1);
      if (com.google.gwt.logging.client.LogConfiguration.loggingIsEnabled()){
        logger3.fine(Crux.getMessages().resourcesInitialized("xStandardResources"));
      }
    }
  }
  private static java.util.logging.Logger logger3 = java.util.logging.Logger.getLogger(xStandardResources_largeDisplayMouse.class.getName());
}
