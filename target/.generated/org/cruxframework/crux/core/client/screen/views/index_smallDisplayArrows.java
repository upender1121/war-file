...
public class index_smallDisplayArrows extends View {
  ...
  protected void createWidgets(){
    setHeight("100%");
    final org.cruxframework.crux.smartfaces.client.viewcontainer.SimpleViewContainer widget11 = GWT.create(org.cruxframework.crux.smartfaces.client.viewcontainer.SimpleViewContainer.class);
    __view.addWidget("views", widget11);
    widget11.loadView("main","main", true);
