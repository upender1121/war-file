...
public class index_largeDisplayMouse extends View {
  ...
  protected void createWidgets(){
    setHeight("100%");
    final org.cruxframework.crux.smartfaces.client.viewcontainer.SimpleViewContainer widget3 = GWT.create(org.cruxframework.crux.smartfaces.client.viewcontainer.SimpleViewContainer.class);
    __view.addWidget("views", widget3);
    widget3.loadView("main","main", true);
