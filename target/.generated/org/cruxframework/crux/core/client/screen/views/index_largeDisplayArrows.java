...
public class index_largeDisplayArrows extends View {
  ...
  protected void createWidgets(){
    setHeight("100%");
    final org.cruxframework.crux.smartfaces.client.viewcontainer.SimpleViewContainer widget = GWT.create(org.cruxframework.crux.smartfaces.client.viewcontainer.SimpleViewContainer.class);
    __view.addWidget("views", widget);
    widget.loadView("main","main", true);
