  ...
  public static void init(){
    if (!View.containsResource("smartFacesResources")){
      ...
      if (com.google.gwt.logging.client.LogConfiguration.loggingIsEnabled()){
        logger4.fine(Crux.getMessages().resourceCsssInjected("CssResource"));
      }
      View.addResource("smartFacesResources", resource2);
      if (com.google.gwt.logging.client.LogConfiguration.loggingIsEnabled()){
        logger4.fine(Crux.getMessages().resourcesInitialized("smartFacesResources"));
      }
    }
  }
  private static java.util.logging.Logger logger4 = java.util.logging.Logger.getLogger(smartFacesResources_largeDisplayMouse.class.getName());
}
