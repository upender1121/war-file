...
public class index_largeDisplayTouch extends View {
  ...
  protected void createWidgets(){
    setHeight("100%");
    final org.cruxframework.crux.smartfaces.client.viewcontainer.SimpleViewContainer widget7 = GWT.create(org.cruxframework.crux.smartfaces.client.viewcontainer.SimpleViewContainer.class);
    __view.addWidget("views", widget7);
    widget7.loadView("main","main", true);
